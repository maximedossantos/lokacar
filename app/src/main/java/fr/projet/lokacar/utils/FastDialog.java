package fr.projet.lokacar.utils;
...
public class FastDialog {
    ...
    public static void showDialogAddVehicule(Context c,
                                             OnClickListener callbk, OnClickListener callbk2) {
        if (c != null) {

            View view = LayoutInflater.from(c).inflate(R.layout.activity_add_vehicule, null);

            TextView categorieVehicule = (TextView) view.findViewById(R.id.categorieVehicule);
